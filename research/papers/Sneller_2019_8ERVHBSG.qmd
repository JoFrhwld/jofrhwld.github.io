...
abstract: "Language acquisition is a well-established avenue for language change (Labov,\
  ...
  \ 40% input from speakers with a nasal /\xE6/ split. We show that applying our simulation\
  \ to a phonological change allows us to make precise quantitative predications about\
  \ the progress of this change. Moreover, it forces us to reassess intuitively plausible\
  \ hypotheses about language change, such as grammatical simplification, in a quantitative\
  \ and independently motivated framework of acquisition."
author:
- name:
    family: Sneller
    given: Betsy
